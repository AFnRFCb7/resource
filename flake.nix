                                                                                                            ...
                                                                                                            let
                                                                                                                ...
                                                                                                                in
                                                                                                                    ''
                                                                                                                        TARGET_INDEX="$1"
                                                                                                                        TARGET_PATH="$2"
                                                                                                                        PID="${ builtins.concatStringsSep "" [ "$" "{" originator-pid-variable ":?" "must be set" "}" ] }"
                                                                                                                        INDEX=0
                                                                                    ...
                                                                                    in
                                                                                        {
                                                                                            ...
                                                                                            target-hash-expected = "${ builtins.concatStringsSep "" ( builtins.sort builtins.lessThan targets ) }" ;
