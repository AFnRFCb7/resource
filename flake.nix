                                                                                            ...
                                                                                            string =
                                                                                                path : value :
                                                                                                    let
                                                                                                        ...
                                                                                                        in
                                                                                                            [
                                                                                                                ''sed -e "s#\$PUBLISH#$0#" -e "s#\$HASH#$HASH#" -e "s#\$INDEX#$INDEX#" -e "s#\$RELEASE#${ applications.release.application }#" -e "w${ resources-directory }/quarantine.init/$INDEX/resolvers/${ qualified-name }.sh ${ resolve }"''
