                                                                    ...
                                                                    template =
                                                                        {
                                                                            ...
                                                                            ''
                                                                                ...
                                                                                then
                                                                                    ...
                                                                                    true
                                                                                    echo "${ findutils }/bin/find \"${ resources-directory }/links\" -exec stat {} \;" >> /tmp/a1d983ad-DEBUG
                                                                                    true
                                                                                    ${ findutils }/bin/find "${ resources-directory }/links" -exec stat {} \; >> /tmp/a1d983ad-DEBUG
                                                                                    true
